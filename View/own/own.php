...
<html lang="en">
  ...
  <head>
    ...
    <title>Alvin - Châu Lâm Đình Ái</title>

    <!-- Bootstrap core CSS -->
    <link href="View/own/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">
    <link rel="shortcut icon" href="View/home/style/favicon.png">
    <!-- Custom fonts for this template -->
    <link href="https://fonts.googleapis.com/css?family=Saira+Extra+Condensed:100,200,300,400,500,600,700,800,900" rel="stylesheet">
    <link href="https://fonts.googleapis.com/css?family=Open+Sans:300,300i,400,400i,600,600i,700,700i,800,800i" rel="stylesheet">
    <link href="View/own/vendor/font-awesome/css/font-awesome.min.css" rel="stylesheet">
    <link href="View/own/vendor/devicons/css/devicons.min.css" rel="stylesheet">
    <link href="View/own/vendor/simple-line-icons/css/simple-line-icons.css" rel="stylesheet">

    <!-- Custom styles for this template -->
    <link href="View/own/css/resume.min.css" rel="stylesheet">
      ...
      <section class="resume-section p-3 p-lg-5 d-flex flex-column" id="skills">
        <div class="my-auto">
          ...
          <ul class="list-inline list-icons">
            ...
            <li class="list-inline-item">
              <i class="devicons devicons-Vuejs"></i>
            </li>
          </ul>
          ...
          <ul class="fa-ul mb-0">
            <li>
              ...
              Website-First, Responsive Back-end PHP</li>
            <li>
              <i class="fa-li fa fa-check"></i>
...
<!--
    ...
    <script src="View/own/vendor/jquery/jquery.min.js"></script>
    <script src="View/own/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>

    <!-- Plugin JavaScript -->
    <script src="View/own/vendor/jquery-easing/jquery.easing.min.js"></script>

    <!-- Custom scripts for this template -->
    <script src="View/own/js/resume.min.js"></script>
