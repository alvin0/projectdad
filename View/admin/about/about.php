...
<h1 class="display-5 mb-4">Update About ( cập nhật trang giới thiệu )  </h1>
<hr>
<form action="index.php?group=admin&active=updateabout<?php echo $this->compact('about') ? '&id=' . $this->compact('about')->id : '' ?>" method="POST" enctype="multipart/form-data">
...
<input type="hidden" name="_token" value="<?php echo _token; ?>" />
	...
	<div class="form-group row">
	  ...
	  <div class="col-10">
	    <input class="form-control" type="text" name="title" id="example-text-input " value="<?php echo isset($this->compact('about')->title) ? $this->compact('about')->title : '' ?>" placeholder="Title (Tiêu Đề)">
	  </div>
	</div>
...
<!-- 	<div class="form-group row">
	...
	<div class="form-group row">
	  ...
	  <div class="col-10">
		 <img src="<?php// echo isset($this->compact('about')->image_index) ? $this->compact('about')->image_index : '/View/admin/styleadmin/noimage.jpg' ?>" id="imagepreview" style="max-width: 200px" class="rounded float-left" alt="...">
	  </div>
	</div> -->
	...
	<div class="form-group row">
	  ...
	  <div class="col-10">
	  	    <textarea class="form-control" name="snippet" id="snippet" rows="3" placeholder="Shortened content will be displayed outside the home page. ( Nội dung rút gọn sẽ được hiển thị ngoài trang chủ )."><?php echo isset($this->compact('about')->snippet) ? $this->compact('about')->snippet : '' ?></textarea>
	...
	<div class="form-group row">
	  ...
	  <div class="col-10">
	    <textarea name="content" id="content" class="content"><?php echo isset($this->compact('about')->content) ? $this->compact('about')->content : '' ?></textarea>
	...
	<div class="form-group row">
      <div class="offset-sm-2 col-sm-10">
        <button type="submit" class="btn btn-primary">Update (Chỉnh Sửa)</button>
      </div>
    </div>
